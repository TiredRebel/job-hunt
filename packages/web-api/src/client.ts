 ...
 * functions (`jobs.ts`, etc.) supply their own request/response types drawn
 * from `@job-hunter/shared-ts`'s generated `ApiOperations`; this module only
 * owns URL/query building, error normalization, and JSON (de)serialization.
 */
