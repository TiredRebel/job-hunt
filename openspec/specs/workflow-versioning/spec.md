...
Version-controlled n8n workflow exports (scrape-scheduler, processing-chain, telegram-notifications, email-digest) with a runbook so the repo stays the canonical source of truth for automation.
