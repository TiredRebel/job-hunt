...
Shared shell for the web dashboard: layout (sidebar + topbar), design tokens and theming, EN/UA localization, global command palette, accessibility/motion baselines, and the typed API access layer all dashboard pages build on.
