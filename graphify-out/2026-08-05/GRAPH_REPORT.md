...
## Corpus Check
- 556 files · ~302,165 words
- Verdict: corpus is large enough that graph structure adds value.

## Summary
- 4903 nodes · 8705 edges · 318 communities (274 shown, 44 thin omitted)
- Extraction: 96% EXTRACTED · 4% INFERRED · 0% AMBIGUOUS · INFERRED: 371 edges (avg confidence: 0.57)
- Token cost: 0 input · 0 output

## Graph Freshness
- Built from commit: `dfbb569c`
...
Cohesion: 0.06
Nodes (25): AUTOMATION_REPOSITORY, AutomationRepository, CoverLetterInput, DigestJobSummary, DigestMatchSummary, DigestPayload, MatchInput, NormalizedJobInput (+17 more)
...
Cohesion: 0.07
Nodes (20): CreateProfileInput, PROFILE_REPOSITORY, ProfileRepository, UpdateProfileInput, AutomationModule, Module, FakeProfileRepository, FakeProfileRepository (+12 more)
...
- **Why does `Profile` connect `Profile` to `automation.service.spec.ts`, `automation.service.ts`, `ProfilesController`, `cover-letters.service.spec.ts`, `AutomationController`?**
