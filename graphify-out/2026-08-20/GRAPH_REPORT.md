# Graph Report - job-hunter (2026-08-20)

## Corpus Check

- 605 files · ~322,375 words
- Verdict: corpus is large enough that graph structure adds value.

## Summary

- 5286 nodes · 9192 edges · 367 communities (320 shown, 47 thin omitted)
- Extraction: 95% EXTRACTED · 5% INFERRED · 0% AMBIGUOUS · INFERRED: 485 edges (avg confidence: 0.59)
- Token cost: 0 input · 0 output

## Graph Freshness

- Built from commit: `d49b3608`
...
- app.module.ts
- PolitenessGate
- postgres-keyword-dictionary.repository.ts
- @dnd-kit/core
...
## Communities (367 total, 47 thin omitted)
...
Cohesion: 0.14
Nodes (10): KeywordDictionaryRepository, UpsertDictionaryInput, FakeKeywordDictionariesService, KeywordDictionary, assertItemsMatchKind(), KeywordDictionariesService, FakeKeywordDictionaryRepository, makeDictionary() (+2 more)
...
Cohesion: 0.05
Nodes (54): BackgroundTasks, ge, le, LookupError, get_settings(), BaseSettings, Runtime configuration for the scraper service. Settings come from environment…, Scraper service settings. Attributes: database_url: PostgreSQL DSN… (+46 more)
...
### Community 21 - "job-detail.tsx"

Cohesion: 0.09
Nodes (25): dynamic, JobDetailPageProps, FOOTER_STAGES, footerStageLabel(), JobDetailView(), JobDetailViewProps, STAGE_OPTIONS, ReactionTimeline() (+17 more)
...
### Community 30 - "stage-card.tsx"

Cohesion: 0.13
Nodes (16): probe, STABLE_ITEMS, STABLE_JOB, daysSince(), StageCard, StageCardInner(), StageCardProps, BoardStage (+8 more)

### Community 32 - "Database"

Cohesion: 0.06
Nodes (46): Database, Persistence layer: PostgreSQL access via psycopg (async pool). Only this module…, Insert a `running` scrape-run row. Args: source_id: FK into `core.sources`.…, Finalize a scrape-run row. Args: run_id: Id returned by :meth:`create_run`.…, Row of `core.sources` used by the runner., Mark a raw job's processing outcome for this attempt. `done` closes the row…, Thin async facade over the connection pool., Create the (closed) pool. Args: dsn: PostgreSQL connection string. (+38 more)
...
Cohesion: 0.07
Nodes (49): BulkActionBar(), BulkActionBarProps, STAGE_OPTIONS, DATE_PRESETS, FilterChip, STAGE_VALUES, PAGE_SIZE_OPTIONS, MultiSelect() (+41 more)

### Community 42 - "CompletionRequest"

Cohesion: 0.04
Nodes (67): AsyncRetrying, BaseException, RetryCallState, ProviderRequestError, The upstream provider HTTP call failed., The provider reply did not validate against the pipeline schema., SchemaValidationError, Ports (interfaces) of the LLM service, in :mod:`llm` domain terms. All LLM… (+59 more)

### Community 43 - "ProviderRow"
...
Cohesion: 0.05
Nodes (77): CoverLetterRequest, CreateProviderRequest, MatchRequest, ModelListResponse, PipelineOverride, ProcessJobRequest, ProcessJobResponse, ProviderConnectionTestRequest (+69 more)
...
Cohesion: 0.06
Nodes (53): dynamic, LABEL_KEY_BY_SHORTCUT, SHORTCUT_KEYS, ShortcutsDialog(), ShortcutsDialogProps, LlmSettingsPageClient(), ConnectionTestState, kindBucket() (+45 more)

### Community 48 - "job-table.tsx"

Cohesion: 0.09
Nodes (28): DeadLetterPage(), dynamic, buildJobColumns(), JobColumnsActions, JobColumnsTranslations, JobRow, translations, JobTable() (+20 more)
...
Cohesion: 0.13
Nodes (26): CoverLetter, GraphDepsDep, RunRecorder, LlmError, PromptInjectionDetectedError, Exception, The composed prompt matched a known prompt-injection pattern., Base class for all LLM-service errors. (+18 more)

### Community 53 - "jobs-client.tsx"

Cohesion: 0.04
Nodes (70): dynamic, dynamic, JobsPage(), JobsPageProps, { refreshMock }, BOARD_STAGES, BoardStage, ALL_JOBS (+62 more)
...
Cohesion: 0.07
Nodes (42): dynamic, JobsDashboardSummary(), JobsDashboardSummaryProps, initialState(), SourceFormBody(), SourceFormBodyProps, SourceFormDialog(), SourceFormDialogProps (+34 more)

### Community 58 - "cover-letters.service.spec.ts"

Cohesion: 0.09
Nodes (25): COVER_LETTER_REPOSITORY, CoverLetterRepository, CoverLetterJobInput, CoverLetterProfileInput, GenerateCoverLetterInput, GeneratedCoverLetter, LLM_COVER_LETTER_CLIENT, LlmCoverLetterClient (+17 more)
...
Cohesion: 0.13
Nodes (27): Load enabled filter dictionaries (re-read on every run). Returns: Rows feeding…, _applies_to(), build_filter_rules(), company_matches(), FilterDictionaryRow, FilterRules, _list_items(), _normalize_term() (+19 more)
...
### Community 63 - "AutomationService"

Cohesion: 0.10
Nodes (20): ApiSecurity, AutomationController, ApiBody, ApiCreatedResponse, ApiOkResponse, ApiOperation, ApiParam, ApiTags (+12 more)
...
Cohesion: 0.12
Nodes (12): CreateSourceInput, SOURCE_REPOSITORY, SourceRepository, UpdateSourceInput, ScrapeRun, Source, mapRunRow(), mapSourceRow() (+4 more)
...
Cohesion: 0.06
Nodes (51): dynamic, dynamic, DictionariesPageClient(), DictionaryCard(), DictionaryCardProps, isStringItems(), KIND_ORDER, kindTitle() (+43 more)

### Community 72 - "_run_provider_test"

Cohesion: 0.07
Nodes (37): BuildProviderDep, CredentialCipherDep, DbDep, InternalTokenDep, ModelListResponse, ProviderTestResponse, ResolverDep, Project a DB row onto the public shape without its ciphertext. (+29 more)
...
### Community 74 - "automation.service.ts"

Cohesion: 0.06
Nodes (15): AUTOMATION_REPOSITORY, RawJob, RawJobOutcome, ScraperClient, ScrapeTriggerResponse, SourceTestResult, JobResultAck, LlmProfileInput (+7 more)

### Community 75 - "sources.controller.ts"

Cohesion: 0.13
Nodes (28): SourceTestStatus, ScrapeRunStatus, FetchStrategy, CreateSourceDto, FETCH_STRATEGIES, ListRunsQueryDto, SetSourceEnabledDto, ApiProperty (+20 more)
...
Cohesion: 0.11
Nodes (19): JobsController, ApiBody, ApiNotFoundResponse, ApiOkResponse, ApiOperation, ApiParam, ApiQuery, ApiTags (+11 more)
...
Cohesion: 0.28
Nodes (7): BOARD_ORDER_REPOSITORY, BoardOrderRepository, AppendReactionInput, JOB_REACTION_REPOSITORY, ReactionsModule, Module, FakeBoardOrderRepository
...
### Community 110 - "make_row"

Cohesion: 0.10
Nodes (33): FetchActive, PostgreSQL access for the LLM service (registry reads, run bookkeeping). Tables…, ModelResolutionError, NoActiveProviderError, Domain errors for the LLM service., `core.llm_providers` has no active row., Neither a pipeline override nor `default_model` yields a model., Structured-output execution engine with constrained retries. Per… (+25 more)
...
Cohesion: 0.21
Nodes (11): looks_like_anti_bot_challenge(), Anti-bot interstitial detection — keeps escalation from becoming evasion. The…, Detect a known anti-bot interstitial (Cloudflare-style challenge page). Args:…, Fetch `url`, escalating to the secondary fetcher when needed. Args: url:…, Tests for anti-bot interstitial detection., test_cloudflare_browser_verification_marker_is_detected(), test_cloudflare_just_a_moment_is_detected(), test_detection_is_case_insensitive() (+3 more)
...
### Community 150 - "cover-letter-editor.tsx"

Cohesion: 0.14
Nodes (16): dsMessages, DsPreviewProviderProps, CoverLetterEditor(), CoverLetterEditorProps, NAV_ITEMS, NavItem, Sidebar(), Tooltip() (+8 more)
...
Cohesion: 0.06
Nodes (34): DateField, JOB_REPOSITORY, JobFilter, JobRepository, JobSortBy, PaginatedJobs, SortDir, FakeJobRepository (+26 more)
...
### Community 184 - "RawJobPosting"

Cohesion: 0.12
Nodes (12): Materialize a posting from the cached listing entry (no re-fetch). Args: lead:…, Persist a raw posting, deduplicating on the unique constraint. Duplicate rows…, Fetched vacancy payload ready for persistence into `scraper.jobs_raw`.…, RawJobPosting, Protocol, Port implemented by every job-source integration. Attributes: slug: Source…, Yield vacancy leads matching `query` from listing pages. Args: query: Search…, Fetch the detail payload for a discovered lead. Args: lead: Lead previously… (+4 more)
...
Cohesion: 0.14
Nodes (8): DatabaseModule, PG_POOL, Global, Module, CaptureDatabase, COUNT_METRICS, JobRow, QueryCall
...
### Community 224 - "FetchResult"

Cohesion: 0.10
Nodes (11): Fetch the configured listing URL for a connectivity check. Returns: The…, Fetch the first configured subreddit's listing, for connectivity testing., Fetch the RSS feed once, for connectivity testing. Unlike :meth:`discover`, a…, FetchResult, Fetch `url`, applying this transport's politeness and rendering. Args: url:…, Result of a page fetch, transport-agnostic. Attributes: text: Response body /…, Fetch this adapter's listing URL once, through its own fetcher. Used only by…, Record the call and return the canned result (or raise). (+3 more)
...
### Community 252 - "SearchDictionaryRow"

Cohesion: 0.11
Nodes (16): Materialize a posting from the cached feed item (no page fetch). Args: lead:…, Load enabled search dictionaries (re-read on every run). Returns: Rows feeding…, content_fingerprint(), Content fingerprinting for cross-run and cross-source dedup. The fingerprint…, Compute a stable fingerprint of a vacancy's meaningful text. Whitespace runs…, build_search_queries(), TypedDict, Subset of a `keyword_dictionaries` row needed to build queries. Attributes:… (+8 more)
...
### Community 262 - "settings.service.ts"
...
Cohesion: 0.08
Nodes (25): DESIGN_OPTIONS, DesignMode, DesignModeToggle(), getClientSnapshot(), getServerSnapshot(), subscribeToHydration(), LocaleSwitch(), CommandPalette() (+17 more)
...
### Community 284 - "app.module.ts"

Cohesion: 0.05
Nodes (34): PLACEHOLDER_ENV, AppModule, Module, AutomationModule, Module, API_CONFIG_NAMESPACE, ApiConfig, ApiEnv (+26 more)
...
### Community 287 - "postgres-keyword-dictionary.repository.ts"

Cohesion: 0.25
Nodes (6): ConflictError, NotFoundError, RepositoryError, mapRow(), PostgresKeywordDictionaryRepository, Injectable
...
Cohesion: 0.13
Nodes (19): AsyncWebCrawler, Crawl4aiFetcher, Render `url` and map the result/failure to fetcher semantics. Isolated as its…, Browser-rendered fetcher via crawl4ai's `AsyncWebCrawler`. The browser is…, Initialize the fetcher. Args: gate: Shared politeness gate (robots + per-host…, Render `url` politely through crawl4ai. Args: url: Absolute URL to fetch.…, Close the underlying browser, if one was started., Lazily start (once) and return the underlying crawler. Raises:… (+11 more)
...
Cohesion: 0.27
Nodes (10): appliesTo(), companyMatches(), CompiledFilterRules, compileFilterRules(), FILTER_DICTIONARY_KINDS, FilterableJob, listItems(), normalizeTerm() (+2 more)

### Community 316 - "0003_llm_settings_notifications.sql"

Cohesion: 0.22
Nodes (8): core.job_matches, core.app_settings, core.llm_providers, core.notifications, llm.pipeline_runs, core.jobs, core.set_updated_at, trg_llm_providers_updated_at
...
### Community 321 - "DictionaryKind"

Cohesion: 0.49
Nodes (4): KEYWORD_DICTIONARY_REPOSITORY, DictionaryKind, KeywordDictionaryResponse, ApiProperty

### Community 322 - "PgDatabase"

Cohesion: 0.15
Nodes (3): PgDatabase, PostgresBoardOrderRepository, Injectable
...
### Community 325 - "job-drawer.tsx"

Cohesion: 0.31
Nodes (6): JobDrawer, Sheet(), SheetContent(), SheetDescription(), SheetTitle(), sheetVariants
...
### Community 341 - "lifespan"

Cohesion: 0.33
Nodes (6): build_fetcher_factory(), lifespan(), FastAPI, FetcherFactory, Resolve a source's `fetch_strategy` to the fetcher its adapter uses. `api`…, Open shared resources (DB pool, HTTP client) for the app lifetime. Args:…

## Knowledge Gaps

- **1629 isolated node(s):** `evaluatorDirectory`, `projectRoot`, `webRoot`, `nextBinary`, `port` (+1624 more)
...
- **Why does `FetchResult` connect `FetchResult` to `EscalatingFetcher`, `escalating.py`, `Crawl4aiFetcher`, `looks_like_anti_bot_challenge`, `FakeDb`, `JobLead`, `fetchers/__init__.py`, `RawJobPosting`?**
  _High betweenness centrality (0.005) - this node is a cross-community bridge._
- **Why does `SourceAdapter` connect `RawJobPosting` to `FetchResult`, `Database`, `create_adapter`, `JobLead`?**
  _High betweenness centrality (0.005) - this node is a cross-community bridge._
- **Why does `test_ollama_uses_the_directly_stored_api_key()` connect `llm/main.py` to `CompletionRequest`, `fetchers/__init__.py`, `make_row`?**
  _High betweenness centrality (0.005) - this node is a cross-community bridge._
