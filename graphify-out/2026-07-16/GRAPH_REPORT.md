# Graph Report - job-hunter (2026-07-16)

## Corpus Check

- 323 files · ~103,986 words
- Verdict: corpus is large enough that graph structure adds value.

## Summary

- 2198 nodes · 4129 edges · 128 communities (115 shown, 13 thin omitted)
- Extraction: 91% EXTRACTED · 9% INFERRED · 0% AMBIGUOUS · INFERRED: 368 edges (avg confidence: 0.64)
- Token cost: 0 input · 0 output

## Graph Freshness

- Built from commit: `3136d6cb`
...
3. `Profile` - 35 edges
4. `ProviderRow` - 33 edges
5. `JobLead` - 33 edges
6. `FakeProvider` - 29 edges
7. `SearchQuery` - 27 edges
8. `ProviderResolver` - 26 edges
9. `PoliteClient` - 26 edges
10. `RawJobPosting` - 25 edges
...
Cohesion: 0.20
Nodes (10): Log, Phase 0 — Bootstrap ✅, Phase 1 — Data model & migrations ✅, Phase 2 — Scraper service (Python, FastAPI) ☐, Phase 3 — LLM service (Python, FastAPI + LangGraph) ✅, Phase 4 — API gateway (NestJS) ✅, Phase 5 — Web app (NextJS) ✅, Phase 6 — n8n workflows ☐ (+2 more)

### Community 1 - "devDependencies"

Cohesion: 0.05
Nodes (38): dependencies, class-transformer, class-validator, @nestjs/common, @nestjs/config, @nestjs/core, nestjs-pino, @nestjs/platform-express (+30 more)

### Community 2 - "Architecture digest"

Cohesion: 0.10
Nodes (20): Context pages, Index — job-hunter wiki, Raw sources (canonical project docs — read in place, never edit from wiki), Tooling, Architecture digest, Data flow, Key ports, Non-negotiable rules (+12 more)

### Community 3 - "devDependencies"

Cohesion: 0.12
Nodes (17): devDependencies, eslint, eslint-config-next, eslint-plugin-jsdoc, jsdom, playwright, @playwright/test, shadcn (+9 more)
...
Cohesion: 0.04
Nodes (46): husky.sh script, description, devDependencies, dbmate, husky, lint-staged, prettier, turbo (+38 more)
...
Cohesion: 0.06
Nodes (45): AppendReactionInput, JOB_REACTION_REPOSITORY, JobReactionRepository, BulkInsertedResponse, DeletedResponse, ApiProperty, CurrentReaction, JobReaction (+37 more)
...
Cohesion: 0.17
Nodes (11): [2026-07-15] checkpoint | Phase 0 complete, Phase 1 (DB & migrations) next, [2026-07-15] checkpoint | Phase 2 scraper service complete (commit 6b24cdc), [2026-07-15] checkpoint | Phase 3 LLM service complete, routes refactored (commit 63b8a59), [2026-07-15] ingest | Graphify code knowledge graph built, [2026-07-15] ingest | Wiki bootstrapped (Karpathy llm-wiki pattern), [2026-07-16] checkpoint | Phase 4 API gateway skeleton + domain APIs done, [2026-07-16] checkpoint | Phase 4 complete — OpenAPI schema enrichment (commit 21b2f40), [2026-07-16] checkpoint | Phase 4 response polish — bigint serializer, common DTOs, pagination mixin (commit b3ada85) (+3 more)
...
Cohesion: 0.06
Nodes (43): LlmSettingsPageClient(), ConnectionTestState, kindBucket(), ProviderCard(), ProviderCardProps, fromProfile(), ProfileForm(), ApiError (+35 more)
...
Cohesion: 0.08
Nodes (40): JobsPage(), JobsPageProps, BOARD_STAGES, BoardStage, StageBoard(), BulkActionBar(), JobsClient(), JobsClientProps (+32 more)
...
Cohesion: 0.09
Nodes (47): BaseModel, GraphDepsDep, MatchRequest, ProcessJobRequest, ProcessJobResponse, ProviderPublic, Request/response models for the REST surface., Input for `POST /process/job` — raw posting plus optional profile. (+39 more)
...
Cohesion: 0.08
Nodes (33): MultiSelect(), MultiSelectOption, MultiSelectProps, LABEL_KEY_BY_SHORTCUT, SHORTCUT_KEYS, ShortcutsDialog(), ShortcutsDialogProps, Badge() (+25 more)

### Community 48 - "utils.ts"

Cohesion: 0.08
Nodes (25): CoverLetterEditor(), CoverLetterEditorProps, LocaleSwitch(), CommandPalette(), CommandPaletteContext, CommandPaletteProvider(), CommandPaletteState, useCommandPalette() (+17 more)

### Community 49 - "job-table-columns.tsx"

Cohesion: 0.08
Nodes (29): daysSince(), StageCard(), StageCardProps, BoardStage, StageColumn(), StageColumnProps, buildJobColumns(), JobColumnsTranslations (+21 more)
...
Cohesion: 0.10
Nodes (21): JobDetailPageProps, BulkActionBarProps, STAGE_OPTIONS, FOOTER_STAGES, footerStageLabel(), JobDetailView(), JobDetailViewProps, STAGE_OPTIONS (+13 more)
...
Cohesion: 0.09
Nodes (24): ApiConfig, ApiEnv, apiEnvSchema, CoverLettersModule, Module, DatabaseModule, PG_POOL, Global (+16 more)

### Community 57 - "sources-page.tsx"

Cohesion: 0.14
Nodes (22): JobRow, JobTable(), JobTableProps, SORTABLE_COLUMN_IDS, SORTABLE_COLUMN_TO_API, formatDuration(), SourceRow(), SourceRowProps (+14 more)

### Community 58 - "cover-letters.service.ts"

Cohesion: 0.17
Nodes (10): COVER_LETTER_REPOSITORY, CoverLetterRepository, CoverLettersService, FakeCoverLetterRepository, Inject, Injectable, CoverLetter, mapRow() (+2 more)

### Community 59 - "profile-repository.port.ts"

Cohesion: 0.21
Nodes (16): CreateProfileInput, PROFILE_REPOSITORY, UpdateProfileInput, RemoteType, Seniority, ProfilePreferences, CreateProfileDto, ProfilePreferencesDto (+8 more)
...
Cohesion: 0.12
Nodes (14): Db, PipelineRunRecord, ProviderRow, Insert one `llm.pipeline_runs` row., A row of `core.llm_providers`., A row for `llm.pipeline_runs` (observability, cost tracking)., Query layer over the shared connection pool., Return all registry rows ordered by slug. (+6 more)

### Community 62 - "Profile"

Cohesion: 0.16
Nodes (5): ProfileRepository, FakeProfileRepository, Profile, FakeProfileRepository, makeProfile()

### Community 63 - ".save"

Cohesion: 0.11
Nodes (18): CoverLettersController, ApiBody, ApiNotFoundResponse, ApiOkResponse, ApiOperation, ApiParam, ApiTags, Body (+10 more)

### Community 64 - "LlmProvider"

Cohesion: 0.19
Nodes (8): LLM_ADMIN_CLIENT, LlmAdminClient, LlmProvider, LlmAdminService, FakeLlmAdminClient, makeProvider(), Inject, Injectable

### Community 65 - ".runs"

Cohesion: 0.15
Nodes (15): SourcesController, ApiBody, ApiCreatedResponse, ApiOkResponse, ApiOperation, ApiParam, ApiQuery, ApiTags (+7 more)

### Community 66 - "Source"

Cohesion: 0.17
Nodes (9): SourceRepository, ScrapeRun, Source, mapRunRow(), mapSourceRow(), PostgresSourceRepository, Injectable, FakeSourceRepository (+1 more)
...
Cohesion: 0.17
Nodes (16): DictionariesPageClient(), DictionaryCard(), DictionaryCardProps, isStringItems(), KIND_ORDER, kindTitle(), Input, createDictionary() (+8 more)

### Community 72 - "filter-bar.tsx"

Cohesion: 0.14
Nodes (15): DATE_PRESETS, FilterBar(), FilterBarProps, FilterChip, presetLabel(), STAGE_VALUES, TagsInput(), TagsInputProps (+7 more)
...
Cohesion: 0.23
Nodes (7): SCRAPER_CLIENT, ScraperClient, ScrapeTriggerResponse, SOURCE_REPOSITORY, HttpScraperClient, Injectable, FakeScraperClient

### Community 75 - "sources.controller.ts"

Cohesion: 0.15
Nodes (15): ScrapeRunStatus, FetchStrategy, ListRunsQueryDto, SetSourceEnabledDto, ApiProperty, ApiPropertyOptional, IsBoolean, IsInt (+7 more)
...
Cohesion: 0.17
Nodes (11): ApiBody, ApiNotFoundResponse, ApiOkResponse, ApiOperation, ApiParam, ApiQuery, Body, Get (+3 more)

### Community 82 - "LlmAdminController"

Cohesion: 0.15
Nodes (11): LlmAdminController, ApiBody, ApiCreatedResponse, ApiOkResponse, ApiOperation, ApiTags, Body, Controller (+3 more)
...
Cohesion: 0.26
Nodes (7): JOB_REPOSITORY, JobsController, ApiTags, Controller, JobsService, Inject, Injectable
...
Cohesion: 0.29
Nodes (3): mapRow(), PostgresProfileRepository, Injectable
...
Cohesion: 0.31
Nodes (7): LlmProviderKind, SetActiveProviderDto, ApiProperty, IsString, LlmProviderResponse, TestConnectionResponse, ApiProperty
...
- **530 isolated node(s):** `husky.sh script`, `printWidth`, `singleQuote`, `trailingComma`, `semi` (+525 more)
...
- **Why does `cn()` connect `cn` to `dict-editor.tsx`, `filter-bar.tsx`, `apiRequest`, `utils.ts`, `job-table-columns.tsx`, `job-detail.tsx`, `sources-page.tsx`?**
  _High betweenness centrality (0.020) - this node is a cross-community bridge._
- **Are the 11 inferred relationships involving `ProviderRow` (e.g. with `MatchRequest` and `ProcessJobRequest`) actually correct?**
  _`ProviderRow` has 11 INFERRED edges - model-reasoned connections that need verification._
- **Are the 10 inferred relationships involving `JobLead` (e.g. with `DouAdapter` and `JobUaAdapter`) actually correct?**
  _`JobLead` has 10 INFERRED edges - model-reasoned connections that need verification._
